...
class Home extends React.Component{
    constructor(props){
        super(props);
        this.state= {
        city=[ AGARTALA,AGRA,AHMEDABAD,AIZWAL,AJMER,ALLAHABAD,ALLEPPEY,ALIBAUG,ALMORA,ALSISAR,ALWAR,AMBALA,AMLA,AMRITSAR,ANAND,
            ANKLESHWAR,ASHTAMUDI,AULI,AURANGABAD,BADDI,BADRINATH,BALASINOR,BALRAMPUR, BAMBORA,BANDHAVGARH,	
                ...
                BHILAI	,    BHIMTAL	,    BHOPAL	,    BHUBANESHWAR,      BHUJ,   BIKANER	, BINSAR	,BODHGAYA,	BUNDI	 ,     CALICUT	,  CANANNORE, CHAIL	,
                CHAMBA	,  CHANDIGARH	, CHENNAI	,CHIKMAGALUR	,CHIPLUN	,  CHITRAKOOT,	CHITTORGARH,COIMBATORE	, COONOOR	,COORG	,
                ...
                FARIDABAD, FIROZABAD,	  GANGOTRI, GANGTOK,GANAPATIPULE	,GANDHIDHAM	,GANDHINAGAR	,GARHMUKTESHWAR,	GARHWAL,  GAYA	,
                GHAZIABAD,  GOA	,GOKHARNA,  GONDAL	,GORAKHPUR,GREATER, GULMARG	,GURGAON	,GURUVAYOOR,	 GUWAHATI,	
                GWALIOR	,HALEBID, HAMPI, HANSI, HARIDWAR,HASSAN	,HOSPET	,  HOSUR	,HUBLI	,HYDERABAD, IDUKKI	, IGATPURI,  IMPHAL	,   INDORE	,JABALPUR,	
                JAIPUR	,JAISALMER,	JALANDHAR,JALGAON	,JAMBUGODHA,  JAMMU	,JAMNAGAR,	 JAMSHEDPUR,JAWHAR	,JHANSI	,
                JODHPUR	,   JOJAWAR	,   JORHAT	,  JUNAGADH,KABINI	,  KALIMPONG,KANATAL	,KANCHIPURAM	, KANHA,	
                KANPUR,	KANYAKUMARI,KARGIL,	KARJAT,	KARNAL,	KARUR	,KARWAR,KASARGOD,	KASAULI	,KASHIPUR, KASHID	,
                KATRA	,KAUSANI	,   KAZA	,KAZIRANGA,KEDARNATH,	KHAJJIAR,KHAJURAHO,	KHANDALA,KHIMSAR	,KOCHIN	,KODAIKANAL,	KOLHA	,
                KOLKATA	,KOLLAM	,  KOTA	, KOTAGIRI,	KOTTAYAM,KOVALAM	,    KUFRI	,KUMBALGARH,KULLU	,KUMARAKOM,	KUMBAKONAM,KUMILY,  
                 KURSEONG	,KUSHINAGAR	, LACHUNG, LEH	,LAKSHADWEEP	,LONAVALA, LOTHAL	,LUCKNOW	,LUDHIANA, MADURAI	,
                MAHABALESHWAR,MAHABALIPURAM,MALAPPURAM	,MALPE	,MALSHEJ GHAT,MALVAN	, MANALI	, MANDAVI	,MANDAWA	,MANESAR,
